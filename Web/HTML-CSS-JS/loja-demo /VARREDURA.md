...
- `data/produtos.json` voltou a ser JSON válido para o Live Server e para o fallback da loja.
...
- `js/firebase-lojas.service.js` é usado pela loja e por `criar-tabelas.html` para criar/atualizar coleções no Firestore.
